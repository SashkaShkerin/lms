...
{{--<!-- Global stylesheets -->--}}
    ...
    <link href=" {{ asset('assets/plugins/bootstrap-5.3.5-dist/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css">
    <link href=" {{ asset('assets/css/bootstrap_limitless.min.css') }}" rel="stylesheet" type="text/css">
    <!-- <link href=" {{ asset('assets/plugins/adminlte/css/adminlte.min.css') }}" rel="stylesheet" type="text/css"> -->
